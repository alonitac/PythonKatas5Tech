...
class TestCountTrueValues(unittest.TestCase):
    ...
    def test_non_boolean_truthy_values(self):
        # These count as True in Python, but not actual `True` booleans
        self.assertEqual(count_true_values([1, 0, "yes", None]), 2)

    def test_only_true_literal(self):
